  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--page-bg)] p-4">
      <div className="max-w-md w-full bg-[var(--component-bg)] p-8 rounded-2xl shadow-2xl shadow-black/30">
        <h2 className="text-3xl font-bold text-center text-[var(--text-accent)] mb-2 font-stylish">Create Account</h2>
        <p className="text-center text-[var(--text-secondary)] mb-8">Get started with your new account</p>
        {error && <p className="bg-red-500/20 text-red-300 p-3 rounded-md mb-4 text-center">{error}</p>}
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-[var(--text-secondary)] text-sm font-bold mb-2" htmlFor="fullName">
              Full Name
            </label>
            <input
              id="fullName"
          ...
          <button
            type="submit"
            className="w-full btn-3d primary !mt-6"
          >
            Sign Up
          </button>
        </form>
